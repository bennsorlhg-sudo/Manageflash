...
const styles = StyleSheet.create({
  ...
  avatar: { width: 72, height: 72, borderRadius: 36, backgroundColor: Colors.roles.supervisor + "22", alignItems: "center", justifyContent: "center", borderWidth: 2, borderColor: Colors.roles.supervisor + "55" },
